...
Your program should contain the global variables given below. The names and
functionality should be the same as it is described. This will allow us to change these
variables to see different results. The default values should also be equal to the given
values below.
